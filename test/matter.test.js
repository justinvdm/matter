describe("matter", function() {
  ...
  describe(".json", function() {
    describe(".inFile", function() {
      it("should parse a file's json front matter", function(done) {
      ...
      it("should parse a file's json front matter embedded in comments", function(done) {
  ...
  describe(".yaml", function() {
    describe(".inFile", function() {
      it("should parse a file's yaml front matter", function(done) {
      ...
      it("should parse a file's yaml front matter embedded in comments", function(done) {
